...
## Tech solutionism and Instant gratification
...
## Ethics and History
Students must also be taught the ethics and history of computers and computing. Computers were invented and created by many humans for many reasons. Babbage wanted to create a computer to replace human workers, while Lovelace and Turing were simply passionate about the mathematics and logic behind computers. The idea of replacing human workers with computers persists even stronger today. 

Additionally, the operating system you are using today not only determines how fast your applications are or how many you can open at once but also which tech company you’re giving your personal information to. 
