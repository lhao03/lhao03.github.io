...
I recently wrote a [rant-like post](/blog/cs-edu/) about my thoughts on my path to CS. Since then, I’ve been thinking of what computer education should look like at the secondary and elementary level (all education targeted towards those 18 and under). The first instance of computer science I came across was in the form of “Everyone should learn how to code”. The more I think about this tech marketing mantra that has been screamed at me from every boot camp, online MOOC, and even President Obama, the more and more I disagree with it; instead we should all learn about computers (no, not how to use Microsoft Word or Excel). 
