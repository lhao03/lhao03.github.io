...
Many human problems are complex problems with a deep history. Turning a human problem into a technical problem may seem like you're solving the human problem, but you may end up "misunderstanding a human problem, introducing a new problem, which shifts the focus and gatekeeps"[^37] and causes harm. An example is a website built by two Harvard students that tried to house refugees from Ukraine[^harvard ukrainian refugee website]. When seemed like a good product was full of security holes and bugs ready for exploitation. For instance, 
...
[^computer stats]: [Share of individuals who have access to a computer in their household in 2020, by country](https://www.statista.com/statistics/1107826/access-to-computer-in-households-worldwide/)

[^36]: Race + Data Science Lecture Series: Ali Alkhatib [(36:21)](https://t.co/RM2hBKW4tw)

[^37]: Race + Data Science Lecture Series: Ali Alkhatib [(37:00)](https://youtu.be/B1v2KIdL5Rs?t=2220)

[^harvard ukrainian refugee website]: [A Website Resettling Ukrainian Refugees Got Adoring Headlines. Experts Say It Was Too Good to Be True.](https://gizmodo.com/harvard-students-refugee-housing-website-ukraine-take-s-1848708164)

[^ffe]: [Fast Food Education](https://www.kernelmag.io/pieces/fast-food-education)
