...
[Critically Conscious Computing](@/blog/papers/compsci/cs-edu/ccc.md){{ss(num="5")}} gives a wonderful overview of the ethics and history of computing, whether it be how algorithms can oppress,  or how the first computers and operating systems came about. [Design Justice](@/blog/papers/compsci/critical/design-justice.md){{ss(num="6")}} also gives insight into how choices can harm individuals, and lastly, [Programmed Inequality](@/blog/papers/compsci/critical/history-computing-women.md){{ss(num="7")}} discusses how women helped create the field of computing and computers, only to be forgotten as computing turned into a male dominated field. These books and their authors explain the area of ethics and history much better than I can in a blog post. I highly recommend you read their works. 

<center>✨</center>

{{ footnote(num="1", title="Teaching creative computer science: Simon Peyton Jones at TEDxExeter.", link="https://www.youtube.com/watch?v=Ia55clAtdMs")}}
{{ footnote(num="2", title="The number glitch that can lead to catastrophe.", link="https://www.bbc.com/future/article/20150505-the-numbers-that-lead-to-disaster")}}
{{ footnote(num="3", title="Git", link="https://git-scm.com/")}}
{{ footnote(num="4", title="FILE NOT FOUND", link="https://www.theverge.com/22684730/students-file-folder-directory-structure-education-gen-z")}}
{{ footnote(num="5", title="Amy J. Ko, Anne Beitlers, Brett Wortzman, Matt Davidson, Alannah Oleson, Mara Kirdani-Ryan, Stefania Druga (2022). Critically Conscious Computing: Methods for Secondary Education.")}}
{{ footnote(num="6", title="Costanza-Chock, S. (2020). Design Justice. The MIT Press.")}}
{{ footnote(num="7", title="Hicks, M. (2018). Programmed inequality: How Britain discarded Women Technologists and lost its edge in computing. MIT Press.")}}
