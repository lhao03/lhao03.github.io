...
I'm a slow learner, and I'm slowly (haha) coming to terms with that. I'm also rediscovering the privilege of learning about things you're interested in for no goal but to learn about these things; I'm not trying to become the next Elon Musk. For instance, I've recently become interested in developer tooling like Semantic[^semantic] and strongly typed programming languages like Haskell and ReScript. I'm learning them when I feel like it and as slow as I want to. I'm also a chemistry nerd at heart, so I've <s>added a biochemistry minor to my degree for no purpose but to nerd out in biochemistry</s> changed my major to computer science and chemistry so I can nerd out in chemistry classes. 
...
[^dj]: Costanza-Chock, S. (2020). Design Justice. The MIT Press.

[^hacking the hackathon]: [Hacking the Hackathon](https://jzhao.xyz/posts/hackathons)

[^programming contests]: [Why might someone really like programming contests but have no desire to go to a hackathon?](https://www.quora.com/Why-might-someone-really-like-programming-contests-but-have-no-desire-to-go-to-a-hackathon)

[^not attending hackathon]: [Why I am not going to attend Hackathons anymore](https://dev.to/shobhitic/why-i-am-not-going-to-attend-hackathons-anymore-2896)

[^fall out of love]: [Fall out of love with the Hackathon](https://thedailytexan.com/2018/05/02/fall-out-of-love-with-the-hackathon/)

[^messenger]: [Messenger.com Now 50% Converted to Reason](https://reasonml.github.io/blog/2017/09/08/messenger-50-reason)

[^cholera]: Colwell, R. R., Huq, A., Islam, M. S., Aziz, K. M. A., Yunus, M., Khan, N. H., … Russek-Cohen, E. (2003). Reduction of cholera in Bangladeshi villages by simple filtration. Proceedings of the National Academy of Sciences, 100(3), 1051–1055. doi:10.1073/pnas.0237386100

[^sari]: [Sari](https://www.encyclopedia.com/places/asia/iranian-political-geography/sari)

[^semantic]: [Semantic](https://github.com/github/semantic)
