...
There's many courses that helped me realize those reasons of why I'm staying in computer science; CPSC 110 and CPSC 213.
...
# Final thoughts
I think that computer science should be taught the same was as chemistry, biology and physics. Learning physics doesn't mean you're a physicist, and that should become the norm with computer science. Additionally, computer science should not just be taught as HTML and JavaScript; we need to also talk about its history. Just like how we learn about the [models of the atom](@/blog/do-good-explanations-have-to-be-true.md) and [different acid base theories](@/blog/do-good-explanations-have-to-be-true.md) in chemistry in junior high and high school and then utilize models like the valence bond theory and hybridization in university, we need to realise computing begins from all the way to the invention of the abacus, to human "computers" in WWII and teach these concepts to young children, and then go into more complex topics (that could be taught to older students) like recursion, graphs, operating systems, compilers and more. This would of been the path to computer science I wished to take. Essentially, treat computer science as the science it is, which includes a rich history; not just what is current and hot.
