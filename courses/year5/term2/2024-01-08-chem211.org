...
* terms
- internal standard: addition of constant amount of substance similar to analyte
- matrix effect: effect of non-analyte on sample
...
- limit of detection: miminum amount of detection
...
- t-statistic: assign confidence limits to average results
- t-test: compare precision of two methods
- F-test: compare if two results are same or different statistically
